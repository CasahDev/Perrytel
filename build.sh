...
# Compilation AArch64
aarch64-linux-gnu-gcc -DAARCH64 -c $ARCH_DIR/boot.S -o $BUILD_DIR/boot.o
...
# Linking
aarch64-linux-gnu-ld -T $ARCH_DIR/linker.ld --no-warn-rwx-segments -o $BUILD_DIR/kernel8.elf $BUILD_DIR/boot.o $BUILD_DIR/uart.o $BUILD_DIR/kernel.o
